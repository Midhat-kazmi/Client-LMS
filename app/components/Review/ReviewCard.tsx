...
const ReviewCard: FC<Props> = ({ item }) => {
  return (
    <div className="w-full h-max pb-4 dark:bg-slate-500 dark:bg-opacity-[0.20] border border-[#00000028] backdrop-blur rounded-lg p-3 shadow-inner">
      <div className="flex w-full">
        ...
        <div className="800px:flex justify-between w-full hidden">
          <div className="pl-4">
            ...
            <h6 className="text-[16px] text-black dark:text-[#ffffab]">
              {item.Profession}
            </h6>
          </div>
