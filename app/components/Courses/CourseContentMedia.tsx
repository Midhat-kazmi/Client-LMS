    ...
    <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
      ...
      <div className="w-full flex items-center justify-between my-3">
        <div
          className={`${
            styles.button
          } text-white  w-[unset]! min-h-10 py-[unset]! ${
        ...
        <div
          className={`${
            styles.button
          } w-[unset]! text-white  min-h-10 py-[unset]! ${
      ...
      {/* Tab Navigation */}
      <div
        className="w-full p-4 flex items-center justify-between bg-slate-500 bg-opacity-20 backdrop-blur 
          rounded "
      >
      ...
      <br />
      {activeBar === 0 && (
        <p className="text-[18px] whitespace-pre-line wrap-break-words mb-3 dark:text-white text-black">
              ...
              <>
                ...
                <div className="w-full flex justify-end">
                  <div
                    className={`${
                      styles.button
                    } w-[120px]! h-10! text-[18px] mt-5 800px:mr-0 mr-2 ${
                      ...
                      {isReviewReply && reviewId === item._id && (
                        <div className="w-full flex relative">
                          <input
                            ...
                            className="block 800px:ml-12 mt-2 outline-none bg-transparent border-b border-black dark:border-white p-[5px] w-[95%]"
                          />
                          <button
                            type="submit"
          ...
          <>
            <div className="w-full flex relative dark:text-white text-black">
              <input
                ...
                className={`block 800px:ml-12 mt-2 outline-none bg-transparent border-b border-[#00000027] dark:text-white text-black dark:border-white p-[5px] w-[95%] 
